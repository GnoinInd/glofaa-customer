...
class BaseView<T extends GetxController> extends GetView {
  ...
  const BaseView({Key? key, required this.viewControl, required this.onPageBuilder, this.appbarPerimeter, this.bottomBarPerimeter,this.floatingActionButton}) : super(key: key);
  @override
                ...
                appbarPerimeter.appBarWidget == null
                    ...
                    child: Center(
                        child: Text(
                          ...
                          style: StyleResource.instance.styleSemiBold(DimensionResource.fontSizeExtraLarge, ColorResource.black),
...
class AppbarPerimeter{
  ...
  AppbarPerimeter({this.backButtonShow = true,this.title= "",this.actionButton =const [],this.appBarBackGroundColor= ColorResource.white,this.backButtonColor = ColorResource.black,this.onTapBackButton,this.elevation,this.appBarWidget});
}
